...
function loadProducts(products) {
    ...
    for (let i = 0; i < products.length; i++) {
        productBlock += '<div class="col-6 col-sm-4"><div class="product-default inner-quickview inner-icon"><figure><a href="javascript:"><img src="ProductImages/' + products[i][2] + '"></a><a href="javascript:" class="quickview-btn" onclick="quickView(\'' + products[i][2] + '\')" title="Quick View">Quick View</a></figure><div class="product-details"><div class="category-wrap"><div class="category-list"><a href="javascript:" class="product-category">' + products[i][0] + '</a></div></div><h3 class="product-title"><a href="javascript:">' + products[i][1] + '</a></h3></div></div></div>';
...
function loadFeaturedProducts(products) {
    ...
    for (let i = 0; i < 8; i++) {
        ...
        featuredProductBlock += '<div class="product-default inner-quickview inner-icon"><figure><a href="javascript:"><img src="ProductImages/' + product[2] + '"></a><a href="javascript:" class="quickview-btn" onclick="quickView(\'' + product[2] + '\')"  title="Quick View">Quick View</a> </figure> <div class="product-details"> <div class="category-wrap"> <div class="category-list"> <a href="javascript:" class="product-category">' + product[0] + '</a> </div> </div> <h3 class="product-title"> <a href="javascript:">' + product[1] + '</a> </h3>  </div></div>';
    }
